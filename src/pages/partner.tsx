...
const Partner = () => {
  ...
  return (
    <div className="flex flex-col justify-center w-full lg:w-4/5 mx-auto">
      ...
      {/* Main section 1 */}
      <div className="flex flex-col md:flex-row justify-between px-4 md:px-10" style={{width:"110%", marginTop:"-5rem"}}>
        {/* Right Section */} 
        <div className="right flex flex-col md:w-2/4 px-4 md:px-8">
          ...
          <div className="mt-4 text-lg space-y-2 text-center md:text-left">
            <p className="leading-relaxed text-2xl text-slate-700 text-center  dark:text-zinc-500">
              Premium, high-end, gourmet desserts,
              <br /> chocolates, and artisanal products. <br />
              Perfect for corporate gifting and bulk orders.
            </p>
            <h2 className="mt-4 text-2xl md:text-3xl text-red-800 p-2 md:p-4 font-semibold  dark:text-zinc-500">
          ...
          <div className="mt-4 md:mt-8 flex justify-center md:justify-start items-center flex-col space-y-4">
            ...
            <p className="text-gray-700 text-lg  dark:text-zinc-500">
            ...
            >
              <img
                ...
                className="w-6 h-6"
              />
              <span className="text-lg text-gray-700  dark:text-zinc-500">
...
<div className="mt-12"></div>
      ...
      <div className="text-center mx-auto px-4 md:px-0">
        <p className="text-slate-700 text-lg md:text-2xl mb-8 md:mb-12  dark:text-zinc-500">
      ...
      <div className="text-center py-6 md:py-10">
        <h1 className="text-3xl md:text-4xl font-bold mb-6 md:mb-12  dark:text-white">

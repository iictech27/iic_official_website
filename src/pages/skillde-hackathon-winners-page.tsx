...
const winnersData = [
  {
    ...
    leader: "Spandan Nag",
    position: "3",
    members: ["Debjyoti Bose", "Sumedha Patra", "Ankita Pathak"],
    projectName: "Weather App (HT102)",
    github: "https://github.com/thenagcode/weather_iic",
    live: "https://weather-iic.vercel.app",
  },
  {
    img: "first",
    team: "sdh_cscs",
    leader: "Anirban RoyChowdhury",
    position: "1",
    members: ["Dwaipayan Bose", "Soumyajit Ghosh"],
    projectName: "Life Manager (HT103)",
    github: "https://github.com/anir-baaaan/todo-list-web-app",
    live: "https://anir-baaaan.github.io/todo-list-web-app/",
  },
  {
    img: "2nd",
    team: "Cicada 3301",
    leader: "Rabindra Choudhary",
    position: "2",
    members: ["Somnath Sadhu", "Prithbee Singh", "Bibaswan Patra"],
    projectName: "Travel Expense Tracker (HT104)",
    github: "https://github.com/Batmancodes1/travcheck",
    live: "",
  },
];

...
const navigation = [
  ...
  { name: "Team", href: "/team" },
  { name: "Internship Portal", href: "/internship" },
    ...
    <div className="sticky top-0 z-10 bg-white shadow dark:bg-black sm:bg-transparent sm:shadow-sm sm:backdrop-blur-md dark:sm:bg-transparent" style={{marginTop:"-8rem"}}>
      ...
      >
        ...
        <div className="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-center lg:gap-x-6">
          ...
          <Link href="/countdown"><button type="button"  className="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Hackathon</button></Link>          
        </div>
